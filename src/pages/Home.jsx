            ...
            >
                <div className="min-h-full flex flex-col items-center justify-center gap-4">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-12">
                        <div className="pointer-events-auto order-2 lg:order-1">
                            <SideLinks />
                        </div>

                        {!isAuthenticated && (
                    <div className="w-full max-w-[320px] bg-black/75 backdrop-blur-2xl border border-white/10 rounded-2xl p-5 shadow-2xl pointer-events-auto order-1 lg:order-2">
