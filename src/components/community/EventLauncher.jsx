...
export default function EventLauncher({ currentUser, onStarted }) {
  ...
  const handleStartEvent = async (template) => {
    ...
    try {
      ...
      toast.error(`Fehler: ${error.message || 'Event konnte nicht gestartet werden'}`);
    } finally {
      setLoadingId(null);
    }
  };
            ...
            >
              ...
              <div className="flex items-center justify-between mt-3">
                ...
                <button
                  ...
                  disabled={loadingId === template.template_id}
                  className="px-3 py-1.5 bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 disabled:opacity-50 text-white text-xs font-bold rounded transition flex items-center gap-1"
                >
                  {loadingId === template.template_id ? (
                    <>
