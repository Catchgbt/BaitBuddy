...
function MapModeManager({
  ...
  const guidedTour = [
    ...
    },
    {
      ...
      icon: '🎨',
      details: [
        '🏔️ Relief-Shading: Bessere räumliche Wahrnehmung',
        '🛰️ Satelliten-Bilder: Präzise Luftaufnahmen',
    ...
    },
    {
      ...
      details: [
        ...
        '🌡️ Hydrographische Daten: Temperatur, Strömung, Tiefe',
      ],
    },
    {
      id: 'ai-features',
    ...
    },
    {
      ...
      details: [
        ...
        '⚙️ Erweitert: Alle Features sofort sichtbar',
      ],
    },
    {
      id: 'complete',
