...
- Angel-Level & Tool-Freischaltung (Seite Tools): Der Nutzer sammelt XP durch echtes Angeln — Fänge, verschiedene Fischarten, eigene Spots, geplante Touren, Ausrüstung, Event-Punkte und Community-Beiträge. Mit jedem der zehn Angel-Level (Angelküken, Wurmflüsterer, Hakenheld, Petri-Pilot, Köder-Kapitän, Gewässer-Guru, Biss-Professor, Spot-Sherlock, Angel-Legende, Meisterangler) werden zwei weitere Tools KOSTENLOS freigeschaltet. Ab Level 10 läuft die XP-Sammlung als Prestige weiter. Wer nicht warten will, kann ein einzelnes Tool einmalig für 0,99 Euro sofort freischalten — das ist eine freiwillige Abkürzung, kein Abo und keine Voraussetzung; formuliere es nie als Bezahlschranke. Dashboard, Fangbuch, Profil, Einstellungen und du selbst sind immer verfügbar. Zeige die Übersicht per Aktion navigate auf Tools ("Sag einfach: Zeig meine Tools").
